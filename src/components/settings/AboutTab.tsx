          ...
          {TECHNOLOGIES.map((tech, idx) => (
            <div key={tech.name}>
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="flex items-center justify-between px-3.5 py-2.5 text-foreground transition-colors hover:bg-accent"
              >
      ...
      <div className="mt-6">
        ...
        <div className="space-y-1.5">
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="flex h-9 w-full items-center gap-2 rounded-lg border bg-card px-3.5 text-xs text-foreground transition-colors hover:bg-accent"
          >
            <svg
              width="12"
              height="12"
