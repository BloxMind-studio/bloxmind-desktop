...
export const APP_COMPONENTS: readonly AppComponentDefinition[] = [
  {
    kind: "heading",
    name: "Heading",
    description: "A page or section heading.",
    icon: "heading",
    defaultProps: { text: "My App", size: "24px", weight: "700" },
    propsSchema: [
      { key: "text", label: "Content", type: "textarea" },
      { key: "size", label: "Font size", placeholder: "24px" },
      { key: "weight", label: "Weight", placeholder: "700" },
    ],
  },
  {
    kind: "text",
