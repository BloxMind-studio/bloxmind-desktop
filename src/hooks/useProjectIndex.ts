...
async function generateProjectIndexProgram(
  ...
  const INITIAL_SYSTEM_PROMPT = `You generate the private TypeScript data provider for BloxMind's project index panel.
  ...
  const created = await client.session.create(
    {
      ...
      agent: undefined,
      metadata: { BloxMindHidden: true, purpose: "project-index", targetKey },
    },
    { throwOnError: true },
  );
